...
- [ ] **PostgreSQL init.sql 外置** - 优化 `app/krathub/service/deployment/kubernetes/postgres.yaml`，将 `init.sql: |` 内联字段外置为独立文件（使用 ConfigMap 挂载或 kustomize configMapGenerator）
