...
func Logger(c *conf.App) log.Logger {
	//配置zap日志库的编码器
...
func getLogWriter(c *conf.App) zapcore.WriteSyncer {
...
func NewZapLogger(c *conf.App, encoder zapcore.EncoderConfig, level zap.AtomicLevel, opts ...zap.Option) *ZapLogger {
	//日志切割
