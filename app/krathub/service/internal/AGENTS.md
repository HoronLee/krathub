...
`app/krathub/service/internal/` 是 Krathub 服务的核心业务实现层，采用严格的 DDD（领域驱动设计）三层架构。这个目录包含所有内部实现代码，通过清晰的层次划分实现业务逻辑与基础设施的解耦。
...
import (
    "context"
    productv1 "github.com/horonlee/krathub/api/gen/go/product/service/v1"
    "github.com/horonlee/krathub/app/krathub/service/internal/biz"
)
