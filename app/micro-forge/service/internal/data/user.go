...
import (
	...
	"github.com/horonlee/micro-forge/app/micro-forge/service/internal/biz/entity"
	dataent "github.com/horonlee/micro-forge/app/micro-forge/service/internal/data/ent"
	entuser "github.com/horonlee/micro-forge/app/micro-forge/service/internal/data/ent/user"
	"github.com/horonlee/micro-forge/pkg/helpers/hash"
	"github.com/horonlee/micro-forge/pkg/logger"
	"github.com/horonlee/micro-forge/pkg/mapper"
)
...
func NewUserRepo(data *Data, l logger.Logger) biz.UserRepo {
	return &userRepo{
		data:   data,
		log:    logger.NewHelper(l, logger.WithModule("user/data/micro-forge-service")),
