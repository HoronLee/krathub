...
`app/micro-forge/service/internal/` 是 micro-forge 服务的核心业务实现层，采用严格的 DDD（领域驱动设计）三层架构。这个目录包含所有内部实现代码，通过清晰的层次划分实现业务逻辑与基础设施的解耦。
...
import (
    ...
    authv1 "github.com/horonlee/micro-forge/api/gen/go/auth/service/v1"
    userv1 "github.com/horonlee/micro-forge/api/gen/go/user/service/v1"
...
vim /Users/horonlee/projects/go/micro-forge/api/protos/product/service/v1/product.proto
...
import (
    "context"
    productv1 "github.com/horonlee/micro-forge/api/gen/go/product/service/v1"
    "github.com/horonlee/micro-forge/app/micro-forge/service/internal/biz"
)
...
- `/Users/horonlee/projects/go/micro-forge/pkg/` - 共享库（jwt, redis, logger, hash 等）

**下游依赖**（依赖本目录的其他目录）：
- `/Users/horonlee/projects/go/micro-forge/app/micro-forge/service/cmd/` - 服务入口（使用 Wire 生成的代码）
