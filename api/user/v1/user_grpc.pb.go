...
const (
	User_CurrentUserInfo_FullMethodName = "/krathub.user.v1.User/CurrentUserInfo"
	User_UpdateUser_FullMethodName      = "/krathub.user.v1.User/UpdateUser"
	User_SaveUser_FullMethodName        = "/krathub.user.v1.User/SaveUser"
