...
const file_user_v1_user_proto_rawDesc = "" +
	"\n" +
	"\x12user/v1/user.proto\x12\x0fkrathub.user.v1\x1a\x1bbuf/validate/validate.proto\x1a\x13errors/errors.proto\x1a\x1cgoogle/api/annotations.proto\"\x18\n" +
	...
	"\x10SAVE_USER_FAILED\x10\x03\x1a\x04\xa8E\xf4\x03\x1a\x04\xa0E\xf4\x032\xca\x03\n" +
	"\x04User\x12x\n" +
	"\x0fCurrentUserInfo\x12'.krathub.user.v1.CurrentUserInfoRequest\x1a%.krathub.user.v1.CurrentUserInfoReply\"\x15\x82\xd3\xe4\x93\x02\x0f\x12\r/v1/user/info\x12n\n" +
	"\n" +
	"UpdateUser\x12\".krathub.user.v1.UpdateUserRequest\x1a .krathub.user.v1.UpdateUserReply\"\x1a\x82\xd3\xe4\x93\x02\x14:\x01*\"\x0f/v1/user/update\x12f\n" +
	"\bSaveUser\x12 .krathub.user.v1.SaveUserRequest\x1a\x1e.krathub.user.v1.SaveUserReply\"\x18\x82\xd3\xe4\x93\x02\x12:\x01*\"\r/v1/user/save\x12p\n" +
	"\n" +
	"DeleteUser\x12\".krathub.user.v1.DeleteUserRequest\x1a .krathub.user.v1.DeleteUserReply\"\x1c\x82\xd3\xe4\x93\x02\x16*\x14/v1/user/delete/{id}BX\n" +
