...
const file_krathub_service_v1_i_user_proto_rawDesc = "" +
	"\n" +
	"\x1fkrathub/service/v1/i_user.proto\x12\x12krathub.service.v1\x1a\x1cgoogle/api/annotations.proto\x1a\x1auser/service/v1/user.proto2\xc4\x04\n" +
	"\vUserService\x12{\n" +
...
var file_krathub_service_v1_i_user_proto_depIdxs = []int32{
	...
	1, // 1: krathub.service.v1.UserService.ListUsers:input_type -> user.service.v1.ListUsersRequest
	2, // 2: krathub.service.v1.UserService.UpdateUser:input_type -> user.service.v1.UpdateUserRequest
	3, // 3: krathub.service.v1.UserService.SaveUser:input_type -> user.service.v1.SaveUserRequest
	4, // 4: krathub.service.v1.UserService.DeleteUser:input_type -> user.service.v1.DeleteUserRequest
	5, // 5: krathub.service.v1.UserService.CurrentUserInfo:output_type -> user.service.v1.CurrentUserInfoResponse
	6, // 6: krathub.service.v1.UserService.ListUsers:output_type -> user.service.v1.ListUsersResponse
	7, // 7: krathub.service.v1.UserService.UpdateUser:output_type -> user.service.v1.UpdateUserResponse
	8, // 8: krathub.service.v1.UserService.SaveUser:output_type -> user.service.v1.SaveUserResponse
	9, // 9: krathub.service.v1.UserService.DeleteUser:output_type -> user.service.v1.DeleteUserResponse
