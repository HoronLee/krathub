...
const file_auth_v1_auth_proto_rawDesc = "" +
	"\n" +
	"\x12auth/v1/auth.proto\x12\aauth.v1\x1a\x1cgoogle/api/annotations.proto\x1a\x17validate/validate.proto\"\xf8\x01\n" +
	"\bUserInfo\x12\x0e\n" +
	...
	"\x0fLoginByPassword\x12\x1f.auth.v1.LoginByPasswordRequest\x1a\x1d.auth.v1.LoginByPasswordReply\"(\x82\xd3\xe4\x93\x02\":\x01*\"\x1d/v1/auth/login/using-password\x12U\n" +
	"\bSayHello\x12\x15.auth.v1.HelloRequest\x1a\x13.auth.v1.HelloReply\"\x1d\x82\xd3\xe4\x93\x02\x17\x12\x15/v1/auth/hello/{name}B?\n" +
...
var file_auth_v1_auth_proto_depIdxs = []int32{
	...
	5, // 3: auth.v1.Auth.SayHello:input_type -> auth.v1.HelloRequest
	2, // 4: auth.v1.Auth.SignupByEmail:output_type -> auth.v1.SignupByEmailReply
	4, // 5: auth.v1.Auth.LoginByPassword:output_type -> auth.v1.LoginByPasswordReply
	6, // 6: auth.v1.Auth.SayHello:output_type -> auth.v1.HelloReply
