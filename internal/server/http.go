...
func NewHTTPServer(c *conf.Server, trace *conf.Trace, auth *service.AuthService, user *service.UserService, mM *mw.MiddlewareManager, logger log.Logger) *http.Server {
