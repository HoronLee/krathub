...
const file_conf_conf_proto_rawDesc = "" +
	...
	"kratos.api\x1a\x1egoogle/protobuf/duration.proto\"\x97\x03\n" +
	"\tBootstrap\x12!\n" +
	...
	"\ametrics\x18\t \x01(\v2\x13.kratos.api.MetricsR\ametrics\"t\n" +
	"\tTLSConfig\x12\x16\n" +
	...
	"\adata_id\x18\b \x01(\tR\x06dataId\"\xb2\x03\n" +
	"\x06Server\x12+\n" +
	...
	"\fservice_name\x18\x01 \x01(\tR\vserviceName\x12\x1a\n" +
	"\bendpoint\x18\x02 \x01(\tR\bendpoint\x123\n" +
	"\atimeout\x18\x03 \x01(\v2\x19.google.protobuf.DurationR\atimeout\"\x8a\x05\n" +
	"\x03App\x12\x10\n" +
	...
	"\bmetadata\x18\x06 \x03(\v2\x1d.kratos.api.App.MetadataEntryR\bmetadata\x1a\xd1\x01\n" +
	"\x03Jwt\x12#\n" +
...
var file_conf_conf_proto_goTypes = []any{
	...
	(*CORS)(nil),                // 2: kratos.api.CORS
	(*ConsulConfig)(nil),        // 3: kratos.api.ConsulConfig
	(*EtcdConfig)(nil),          // 4: kratos.api.EtcdConfig
	(*NacosConfig)(nil),         // 5: kratos.api.NacosConfig
...
var file_conf_conf_proto_depIdxs = []int32{
	9,  // 0: kratos.api.Bootstrap.app:type_name -> kratos.api.App
	6,  // 1: kratos.api.Bootstrap.server:type_name -> kratos.api.Server
	7,  // 2: kratos.api.Bootstrap.client:type_name -> kratos.api.Client
	8,  // 3: kratos.api.Bootstrap.data:type_name -> kratos.api.Data
	10, // 4: kratos.api.Bootstrap.registry:type_name -> kratos.api.Registry
	11, // 5: kratos.api.Bootstrap.discovery:type_name -> kratos.api.Discovery
	12, // 6: kratos.api.Bootstrap.config:type_name -> kratos.api.Config
	13, // 7: kratos.api.Bootstrap.trace:type_name -> kratos.api.Trace
	14, // 8: kratos.api.Bootstrap.metrics:type_name -> kratos.api.Metrics
	27, // 9: kratos.api.CORS.max_age:type_name -> google.protobuf.Duration
	27, // 10: kratos.api.ConsulConfig.timeout:type_name -> google.protobuf.Duration
	27, // 11: kratos.api.EtcdConfig.timeout:type_name -> google.protobuf.Duration
	27, // 12: kratos.api.NacosConfig.timeout:type_name -> google.protobuf.Duration
	...
	3,  // 22: kratos.api.Registry.consul:type_name -> kratos.api.ConsulConfig
	4,  // 23: kratos.api.Registry.etcd:type_name -> kratos.api.EtcdConfig
	5,  // 24: kratos.api.Registry.nacos:type_name -> kratos.api.NacosConfig
	3,  // 25: kratos.api.Discovery.consul:type_name -> kratos.api.ConsulConfig
	4,  // 26: kratos.api.Discovery.etcd:type_name -> kratos.api.EtcdConfig
	5,  // 27: kratos.api.Discovery.nacos:type_name -> kratos.api.NacosConfig
	3,  // 28: kratos.api.Config.consul:type_name -> kratos.api.ConsulConfig
	4,  // 29: kratos.api.Config.etcd:type_name -> kratos.api.EtcdConfig
	5,  // 30: kratos.api.Config.nacos:type_name -> kratos.api.NacosConfig
	27, // 31: kratos.api.Server.HTTP.timeout:type_name -> google.protobuf.Duration
	1,  // 32: kratos.api.Server.HTTP.tls:type_name -> kratos.api.TLSConfig
	2,  // 33: kratos.api.Server.HTTP.cors:type_name -> kratos.api.CORS
	27, // 34: kratos.api.Server.GRPC.timeout:type_name -> google.protobuf.Duration
	1,  // 35: kratos.api.Server.GRPC.tls:type_name -> kratos.api.TLSConfig
	1,  // 36: kratos.api.Client.GRPC.tls:type_name -> kratos.api.TLSConfig
